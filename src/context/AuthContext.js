...
export const { Provider, Context } = createDataContext(
    authReducer,
    { changePassword, checkIfLoggedIn, checkIfNotLoggedIn, clearErrorMessage, clearHasEmailed, deleteAccount, getAccount, getUser, sendMeEmail, signin, signout, signup, verifyCreateAccount, verifyChangePassword, verifydeleteAccount },
